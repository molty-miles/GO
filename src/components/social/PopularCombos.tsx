...
export function PopularCombos() {
  return (
    <section>
      <h2 className="mb-3 text-lg font-bold text-foreground">Popular Combos</h2>
      <div className="grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
        {MOCK_COMBOS.map((combo, i) => (
          <div
            key={i}
            className="rounded-xl border bg-card p-4 transition-colors hover:border-zinc-700"
          >
            <div className="mb-2 flex items-center gap-2">
              ...
              <div className="ml-auto flex items-center gap-1">
                ...
                <span className="text-xs text-muted-foreground">{combo.popularity}%</span>
              </div>
            </div>
